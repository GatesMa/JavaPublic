...
public class TokenServiceSpringServiceTest {
    ...
    public static void main(String[] args) throws Exception {
        // om crm
        System.out.println(
                "om_crm prod: " + tokenService.encode("om_crm", "om_crm", "58006f979159di0FHAtN!5qJ1h4DRM#-"));
        // crm
        ...
        // customer_service
        System.out.println("cs prod: " + tokenService.encode("customer_service", "customer_service",
                "8d7c6e3e6e2az#SKIbpnEHYPgiFd2b$2"));
        System.out.println("cs dns: " + tokenService.encode("customer_service", "customer_service",
                "8d7c6e3e5c05*)Y{r(6{QQt#$aYKMz9{"));
        System.out.println("cs dev: " + tokenService.encode("customer_service", "customer_service",
                "8d7c6e3e574eS%}}6i1Nttx0LGX5GodQ"));
        System.out.println("cs sandbox: " + tokenService.encode("customer_service", "customer_service",
                "557cc9de2734apEX#FZKJm|dKp|Vv+72"));
        System.out.println("cs sandbox: " + tokenService.encode("business_manager", "business_manager",
                "557cc9de2734apEX#FZKJm|dKp|Vv+72"));

        //sso
        System.out.println("sso prod: " + tokenService.encode("sso", "sso", "57259d33ca6bfR5zF{)dB05V}&NRiT#&"));
        //new_agency
        System.out.println("new_agency prod: " + tokenService.encode("'new_agency'", "'new_agency'",
                "55890a294232b)|yJQWj,L|me7+-xv54"));
        //report-service
        System.out.println(
                "report-serVice prod: " + tokenService.encode("crm", "crm", "54bb173c23469s,B9Snwt*J~PMV2)U~h"));
